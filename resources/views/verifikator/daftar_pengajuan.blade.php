                                                    ...
                                                    <div class="row text-left">
                                                        <div class="col-md-12">
                                                            <div class="card shadow-sm">
                                                                ...
                                                                @endforeach
                                                                @if ($data2->wf_reference_id == '1')
                                                                    <div class="card-header text-center">
                                                                        <div class="row">
                                                                            <div class="col-lg-12">
                                                                                <a href="{{ route('tolakpengajuan', $data2->id) }}"
                                                                                    class="btn btn-sm btn-danger">Tolak
                                                                                    Permintaan</a>
                                                                                <a href="{{ route('terimapengajuan', $data2->id) }}"
                                                                ...
                                                                <table class="table table-bordered" style="width:100%">
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <th>Tempat Lahir</th>
                                                                            <td>{{ $data2->user->nik->tempat_lahir }}
                                                                            </td>
                                                                        </tr>

                                                                        <tr>
                                                                            <th>Tanggal Lahir</th>
                                                                            <td>{{ $data2->user->nik->tanggal_lahir }}
                                                                            </td>
                                                                            <th>Status Perkawinan</th>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <th>Jenis Kelamin</th>
                                                                            <td>{{ $data2->user->nik->jenis_kelamin }}
                                                                            </td>
                                                                        </tr>
