                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="card shadow-sm">
                                                                    <div class="card-header text-center">
                                                                        <div class="row">
                                                                            <div class="col-lg-12">
                                                                                @if ($data->user_level_id == '5')
                                                                                    <a href="{{ route('teruskanpengaduan_rt', $data->id_pengaduan) }}"
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <div class="form-group">
                                                                                            <form method="POST"
                                                                                                action="{{ route('tanganipengaduan_rt') }}">
                                                                                                @csrf
                                                                                                <input type="hidden"
                                                                                                    name="id"
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('.data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('daftar_pengaduan_rt') }}",
                columns: [{
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('.data-table2').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('daftar_pengaduan2_rt') }}",
                columns: [{
                        data: 'user.nik.id_ktp',
                        name: 'id_pengaduan'
                    },
