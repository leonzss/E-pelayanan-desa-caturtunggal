                                                    ...
                                                    <div class="row text-left">
                                                        <div class="col-md-12">
                                                            <div class="card shadow-sm">
                                                                ...
                                                                @endforeach
                                                                @if ($data2->wf_reference_id == '2')
                                                                    <div class="card-header text-center">
                                                                        <div class="row">
                                                                            <div class="col-lg-12">
                                                                                <a href="{{ route('tolakpengajuan_rt', $data2->id) }}"
                                                                                    class="btn btn-sm btn-danger">Tolak
                                                                                    Permintaan</a>
                                                                                <a href="{{ route('terimapengajuan_rt', $data2->id) }}"
                                                ...
                                                <div class="row text-left">
                                                    <div class="col-md-12">
                                                        <div class="card shadow-sm">
                                                            ...
                                                            @endforeach
                                                            @if ($data3->wf_reference_id == '2')
                                                                <div class="card-header text-center">
                                                                    <div class="row">
                                                                        <div class="col-lg-12">
                                                                            <a href="{{ route('tolakpengajuan_rt', $data3->id) }}"
                                                                                class="btn btn-sm btn-danger">Tolak
                                                                                Permintaan</a>
                                                                            <a href="{{ route('terimapengajuan_rt', $data3->id) }}"
                                                                                class="btn btn-sm btn-core">Terima
                                                                                Permintaan</a>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('.data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('daftar_pengajuan_rt') }}",
                columns: [{
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('.data-table2').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('daftar_pengajuan2_rt') }}",
                columns: [{
                        data: 'user.nik.id_ktp',
                        name: 'id_pengajuan'
                    },
