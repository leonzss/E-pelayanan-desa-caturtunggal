...
<body>
    <div>
        ...
        <div id="isi3">
            ...
            <table width="100%">
                <tr>
                    <td class="indentasi" width="80%">
                        Menurut pengamatan kami orang tersebut di atas, baik langsung maupun tidak langsung,
                        tidak pernah tersangkut <br> urusan polisi. Adapun surat keterangan ini dibuat untuk :</td>
                </tr>
            </table><br>
            <table width="100%" style="text-transform: capitalize;">
                <tr>
                    <td class="indentasi" style="text-align:center;"><b><u>{{ $data->kebutuhan }}</u></b></td>
                </tr>
            </table><br>
            <table width="100%">
                <tr>
