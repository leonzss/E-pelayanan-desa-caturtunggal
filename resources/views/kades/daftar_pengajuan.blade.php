@extends('layout.kades')

@section('nav')

    <li class="nav-item">
        <a class="nav-link" href="{{ route('kades.home') }}">Beranda</a>
    </li>
                                                    ...
                                                    <div class="row text-left">
                                                        <div class="col-md-12">
                                                            <div class="card shadow-sm">
                                                                ...
                                                                @endforeach
                                                                @if ($data2->wf_reference_id == '4')
                                                                    <div class="card-header text-center">
                                                                        <div class="row">
                                                                            <div class="col-lg-12">
                                                                                <a href="{{ route('tolakpengajuan_kades', $data2->id) }}"
                                                                                    class="btn btn-sm btn-danger">Tolak
                                                                                    Permintaan</a>
                                                                                <a href="{{ route('terimapengajuan_kades', $data2->id) }}"
                                                                    ...
                                                                    <table class="table table-bordered" style="width:100%">
                                                                        <tbody>
                                                                            ...
                                                                            @php
                                                                                ...
                                                                                $path2 = Storage::url('img/' . $data->Lampiran_2);
                                                                                $path3 = Storage::url('img/' . $data->Lampiran_3);
                                                                ...
                                                                <table class="table table-bordered" style="width:100%">
                                                                    <tbody>
                                                                        ...
                                                                        @php
                                                                            ...
                                                                            $path2 = Storage::url('img/' . $data2->Lampiran_2);
                                                                            $path3 = Storage::url('img/' . $data2->Lampiran_3);
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('.data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('daftar_pengajuan_kades') }}",
                columns: [{
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('.data-table2').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('daftar_pengajuan2_kades') }}",
                columns: [{
                        data: 'user.nik.id_ktp',
                        name: 'id_pengajuan'
                    },
