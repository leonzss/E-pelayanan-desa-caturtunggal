@if (Session::get('verifikator') == false)
...
<head>
    ...
    <title>e-Pelayanan - Verifikator</title>
</head>
                ...
                <ul class="navbar-nav mx-auto text-uppercase">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="{{ route('daftar_masyarakat') }}">Validasi Akun</a>
                            <a class="dropdown-item" href="{{ route('daftar_pengajuan') }}">Pengajuan Surat</a>
                            <a class="dropdown-item" href="{{ route('daftar_pengaduan') }}">Pengaduan Layanan</a>
                            <a class="dropdown-item" href="{{ route('daftar_penduduk_verifikator') }}">Data Penduduk Desa Caturtunggal</a>
                        </div>
                    </li>
                </ul>
