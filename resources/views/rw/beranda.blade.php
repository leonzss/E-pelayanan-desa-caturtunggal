            ...
            @foreach ($notif as $data)
                @if ($data->jumlah != '0')
                    @if ($data->jenis == 'Pengaduan')
                        <a href="{{ route('daftar_pengaduan_rw') }}" class="dropdown-item"><span
                                class="badge badge-pill badge-core">{{ $data->jumlah }} </span> {{ $data->pesan }}</a>
                    @elseif($data->jenis == "Pengajuan")
                        <a href="{{ route('daftar_pengajuan_rw') }}" class="dropdown-item"><span
                                class="badge badge-pill badge-core">{{ $data->jumlah }} </span> {{ $data->pesan }}</a>
                    @endif
                @endif
            @endforeach
            ...
            <div class="row mb-2">
                <div class="col-lg-6">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-footer py-4">
                            <a href="{{ route('daftar_pengajuan_rw') }}" class="btn btn-core btn-block">Cek
                                Pengajuan</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="card shadow-sm">
                            ...
                            <div id="accordion3">
                                ...
                                <div class="card mb-0" style="border: none;">
                                    ...
                                    <div id="collapsePengaduanDua" class="collapse pt-2" aria-labelledby="pengaduanDua"
                                        ...
                                        Pilih Teruskan ke KADES atau Tangani Pengaduan.
                                    </div>
                                </div>
                                <div class="card mb-0" style="border: none;">
                        ...
                        <div class="card-footer py-4">
                            <a href="{{ route('daftar_pengaduan_rw') }}" class="btn btn-core btn-block">Cek
                                Pengaduan</a>
                        </div>
                    </div>
                </div>
